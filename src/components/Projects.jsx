...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Full-stack chat application with real-time messaging, file sharing, and user presence indicators.",
    ...
    },
    {
      ...
      description: "Interactive dashboard for data visualization with charts, filters, and real-time updates.",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      demo: "https://dashboard-demo.com",
      github: "https://github.com/yourusername/analytics-dashboard",
      category: "frontend",
      tags: ["React", "D3.js", "Chart.js", "API Integration"],
      status: "completed",
      featured: false
    }
  ];
